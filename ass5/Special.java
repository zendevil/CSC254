...
class Philosopher extends Thread {
    ...
    private void think() throws ResetException {
        color = THINK_COLOR;
        t.repaint();
	System.out.println(this.getPhilosopherName() + " thinking");
	...
	System.out.println(this.getPhilosopherName() + " waiting");
        delay(FUMBLE_TIME);
	...
	//System.out.println(this.getPhilosopherName() + " lf: " + hasFork.get(leftFork) + " rf: " + hasFork.get(rightFork));
        ...
        t.repaint();
	status = Status.EATS;
	System.out.println(this.getPhilosopherName() + " eating");
	setDirtyForks();
        delay(EAT_TIME);
	status = Status.THINKS;
	while (hasFork.get(leftFork) || hasFork.get(rightFork)) {
